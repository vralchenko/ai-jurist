        ...
        <footer className="w-full py-2 px-4 border-t border-slate-100 dark:border-slate-800/30 bg-white dark:bg-[#08080a] shrink-0">
            <div className="w-full text-center space-y-1">
                ...
                <div className="flex justify-center gap-3">
                    ...
                    <a href="https://github.com/vralchenko" target="_blank" rel="noopener noreferrer" className="text-[9px] lg:text-[10px] text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition-colors">GitHub</a>
                </div>
            </div>
        </footer>
    );
